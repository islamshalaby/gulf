...
<div class="row" >
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-content">
                                        @if(in_array($recent_order->status, [1, 2, 3]))
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th><div class="th-content th-heading">{{ __('messages.product_price') }}</div></th>
    ...
    @if (count($data['shipping_orders']) > 0)
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-table-three">

            <div class="widget-heading">
                <h5 class="">{{ __('messages.shipping_orders') }}</h5>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                                <th><div class="th-content">{{ __('messages.order_number') }}</div></th>
                                <th><div class="th-content">{{ __('messages.shipment_number') }}</div></th>
                                <th><div class="th-content">{{ __('messages.product_title') }}</div></th>
                                <th><div class="th-content th-heading">{{ __('messages.product_price') }}</div></th>
                                <th><div class="th-content th-heading">{{ __('messages.shipping_cost') }}</div></th>
                                <th><div class="th-content th-heading">{{ __('messages.total') }}</div></th>
                                <th><div class="th-content">{{ __('messages.status') }}</div></th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($data['shipping_orders'] as $order)
                            <tr>
                                <td><div class="td-content product-name"><a href="{{ route('orders.details', $order->order_id) }}" >{{ $order->order->order_number }}</a></div></td>
                                <td><div class="td-content product-name"><span class="badge outline-badge-warning">{{ $order->shipment ? $order->shipment->airway_bill_number : '' }}</span></div></td>
                                <td><div class="td-content product-name">{{ App::isLocale('en') ? $order->product->title_en : $order->product->title_ar }}</div></td>
                                <td><div class="td-content"><span class="discount-pricing">{{ $order->final_price . " " . __('messages.dinar') }}</span></div></td>
                                <td><div class="td-content"><span class="discount-pricing">{{ $order->shipping_cost . " " . __('messages.dinar') }}</span></div></td>
                                <td><div class="td-content"><span class="discount-pricing">{{ ($order->shipping_cost + $order->final_price) . " " . __('messages.dinar') }}</span></div></td>
                                <td>
                                    <div class="td-content">
