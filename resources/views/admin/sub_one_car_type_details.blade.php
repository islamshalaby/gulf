                ...
                <table class="table table-bordered mb-4">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $data['sub_one_car_type']['title_en'] }}
                            </td>
                        </tr>
                        <tr>
                            <td class="label-table" > {{ __('messages.title_ar') }}</td>
                            <td>
                                {{ $data['sub_one_car_type']['title_ar'] }}
                            </td>
                        </tr>   
                        <tr>
                            <td class="label-table" > {{ __('messages.category') }}</td>
                            <td>
                                <a href="{{ route('car_types.details', $data['sub_one_car_type']['car_type_id']) }}">
                                {{ App::isLocale('en') ? $data['sub_one_car_type']->carType->title_en : $data['sub_one_car_type']->carType->title_ar }}
                                </a>
                            </td>
                        </tr>
