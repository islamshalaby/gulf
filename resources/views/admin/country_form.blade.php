    ...
    <div class="col-lg-12 col-12 layout-spacing">
        ...
        <form action="" method="post" enctype="multipart/form-data" >
            ...
            <div class="form-group mb-4">
                ...
                <input required type="text" name="currency" class="form-control" id="currency" placeholder="{{ __('messages.currency') }}" value="" >
            </div>    
            <div class="form-group mb-4">
                <label for="currency_ar">{{ __('messages.currency_ar') }}</label>
                <input required type="text" name="currency_ar" class="form-control" id="currency_ar" placeholder="{{ __('messages.currency_ar') }}" value="" >
            </div>    
            <div class="form-group mb-4">
