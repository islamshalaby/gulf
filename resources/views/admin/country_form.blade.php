    ...
    <div class="col-lg-12 col-12 layout-spacing">
        ...
        <form action="" method="post" enctype="multipart/form-data" >
            ...
            <div class="custom-file-container" data-upload-id="myFirstImage">
                <label>{{ __('messages.upload') }} ({{ __('messages.flag') }}) <a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image">x</a></label>
                <label class="custom-file-container__custom-file" >
                    <input type="file" required name="flag" class="custom-file-container__custom-file__custom-file-input" accept="image/*">
            ...
            <div class="form-group mb-4">
                ...
                <input required type="text" name="currency" class="form-control" id="currency" placeholder="{{ __('messages.currency') }}" value="{{ old('currency') }}" >
            </div>    
            <div class="form-group mb-4">
                <label for="currency_ar">{{ __('messages.currency_ar') }}</label>
                <input required type="text" name="currency_ar" class="form-control" id="currency_ar" placeholder="{{ __('messages.currency_ar') }}" value="{{ old('currency_ar') }}" >
            </div> 
