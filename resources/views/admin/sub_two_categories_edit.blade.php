        ...
        <form action="" method="post" enctype="multipart/form-data" >
            ...
            <div class="form-group">
                ...
                <select id="category" name="sub_category_id" class="form-control">
                    ...
                    <option {{ $category->id == $data['sub_category']['sub_category_id'] ? 'selected' : '' }} value="{{ $category->id }}">{{ App::isLocale('en') ? $category->title_en . " - " . $category->category->title_en : $category->title_ar . " - " . $category->category->title_ar }}</option>
                    @endforeach
                </select>
            </div>
