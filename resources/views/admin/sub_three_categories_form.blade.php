        ...
        <form action="" method="post" enctype="multipart/form-data" >
            ...
            <div class="form-group">
                ...
                <select id="category" name="sub_category_id" class="form-control">
                    ...
                    <option value="{{ $category->id }}">{{ App::isLocale('en') ? $category->title_en . " - " . $category->category->title_en . " - " . $category->category->category->title_en : $category->title_ar . " - " . $category->category->title_ar . " - " . $category->category->category->title_ar }}</option>
                    @endforeach
                </select>
            </div>
