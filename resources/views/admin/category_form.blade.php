...
@section('content')
    <div class="col-lg-12 col-12 layout-spacing">
        ...
        <form action="{{ Request::segment(2) == 'categories' ? route('categories.add') : route('categories.ads.add') }}" method="post" enctype="multipart/form-data" >
            @csrf
            ...
            <div class="form-group">
                ...
                <select id="category" name="sub_car_type_id" class="form-control">
                    ...
                    <option value="{{ $category->id }}">{{ App::isLocale('en') ? $category->title_en . " - " . $category->carType->title_en . " - " . $category->carType->carType->title_en : $category->title_ar . " - " . $category->carType->title_ar . " - " . $category->carType->carType->title_ar }}</option>
                    @endforeach
                </select>
            </div>
