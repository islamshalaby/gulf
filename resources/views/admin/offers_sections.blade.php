                    ...
                    <tbody id="sortable">
                        ...
                        @foreach ($data['offers_sections'] as $section)
                            <tr id="id_{{ $section['id'] }}">
                                ...
                                <td class="text-center blue-color"><a href="{{ route('offers_control.details', $section->id) }}" ><i class="far fa-eye"></i></a></td>
                                @if(Auth::user()->update_data) 
                                    <td class="text-center blue-color" ><a href="{{ route('offers_control.edit', $section->id) }}" ><i class="far fa-edit"></i></a></td>
                                @endif
                                @if(Auth::user()->delete_data) 
