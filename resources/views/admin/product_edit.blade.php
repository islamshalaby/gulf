    ...
    <script>
        ...
        var categoryId = $("#category").find("option:selected").val();
            ...
            $(".actions ul").find('li').eq(1).on("mouseover", "a.next1", function() {
                ...
                if (categorySelect > 0 && subCarOneSelect > 0 && companySelect > 0 && yearInput.length > 0 && subCarTwoSelect > 0 && mainSectionSelect > 0 && subMainSectionSelect > 0 && titleEnInput.length > 0 && titleArInput.length > 0 && descriptionEnText.length > 0 && descriptionArText.length > 0) {
                    $(this).attr('href', '#next')
                    $(this).addClass('next2')
                ...
                <div class="widget-content widget-content-area">
                    <div id="circle-basic" class="">
                        ...
                        <section>
                            ...
                            <div style="{{ empty($data['product']['sub_category_id']) ? 'display: none' : '' }}" class="form-group">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input required type="text" name="year" class="form-control" id="year" placeholder="{{ __('messages.year') }}" value="{{ $data['product']['year'] }}" >
                            </div>
                        ...
                        <section>
                            ...
                            {{-- <div class="form-group mb-4" >
                                <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
                                  <input name="selected" {{ $data['product']['selected'] == 1 ? 'checked' : '' }} value="1" type="checkbox" class="new-control-input">
