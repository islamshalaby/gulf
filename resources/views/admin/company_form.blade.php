...
@section('title' , __('messages.add_new_company'))
    ...
    <div class="col-lg-12 col-12 layout-spacing">
        ...
        <form action="" method="post" enctype="multipart/form-data" >
            ...
            <div class="form-group mb-4">
                ...
                <input required type="text" name="email" class="form-control" id="email" placeholder="{{ __('messages.email') }}" value="{{ old('email') }}" >
            </div>
            <div class="form-group mb-4">
            ...
            <div class="form-group">
                ...
                <select required class="form-control" name="area_id" id="sel1">
                    ...
                    <option value="{{ $area->id }}">{{ App::isLocale('en') ? $area->name_en : $area->name_ar }}</option>
                    @endforeach
                </select>
            </div>
