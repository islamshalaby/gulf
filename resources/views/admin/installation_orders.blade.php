        ...
        <div class="statbox widget box box-shadow">
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>{{ __('messages.show_installation_orders') }} 
                        @if (isset($data['area']))
                            @if(App::isLocale('en'))
                                {{ "( " . $data['area']['title_en'] . " )" }}
                            @else
                    ...
                    @endphp
                    <a href="{{ route('webview.installationReport', $queryArray) }}" target="_blank" class="btn btn-primary">{{ __('messages.print') . ' ' . __('messages.installation_report') }}</a>
                </div>
            </div>
        </div>
        <div class="widget-content widget-content-area">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{ __('messages.order_delivered') }}
                                        <a class="btn btn-info" onclick='return confirm("{{ __('messages.are_you_sure') }}");' href="{{ route('orders.install.item', $order->id) }}">
                                            {{ __('messages.installed') }}
                                        </a>
                                    @endif
                                </td>
                                
                                <td class="text-center blue-color hide_col"><a target="_blank" href="{{ route('orders.details', $order->order_id) }}" ><i class="far fa-eye"></i></a></td>
                                <td class="text-center blue-color hide_col"><a target="_blank" href="{{ route('orders.invoice', $order->order_id) }}?download=1" ><i class="far fa-eye"></i></a></td>
                            </tr>
                            <?php $i ++ ?>
                        @endforeach
                    </tbody>
