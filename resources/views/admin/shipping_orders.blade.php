...
@push('scripts')
    ...
    <script>
        ...
        var totalPrice = parseFloat(price.reduce(function (a, b) { return parseFloat(a) + parseFloat(b); }, 0)).toFixed(3),
            totalShipping = parseFloat(shipping.reduce(function (a, b) { return parseFloat(a) + parseFloat(b); }, 0)).toFixed(3),
        ...
        $("#order-tbl tfoot").find('th').eq(8).text(`${totalShipping} ${dinar}`);
