                    ...
                    <tbody>
                        ...
                        @foreach ($data['sub_categories'] as $sub_category)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ Request::segment(2) == 'categories' ? route('categories.details', $sub_category->category->id) : route('categories.ads.details', $sub_category->category->id) }}">
                                        {{ App::isLocale('en') ? $sub_category->category->title_en : $sub_category->category->title_ar }}
                                    </a>
                                </td>
                                <td>
                                    <a href="{{route('cat_options.show',[1, $sub_category->id])}}">
                                        <div class="">
