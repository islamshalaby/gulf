    ...
    <script>
        ...
        $("#type").on("change", function() {
            if ($(this).val() == 1 ) {
                ...
                $.ajax({
                    url : "/admin-panel/adpro_home_sections/fetch/" + $(this).val(),
                    type : 'GET',
                    success : function (data) {
                        $("#ads_check").show()
                        $("#ads_check").parent(".form-group").hide()
                                ...
                                <div class="col-md-3" >
                                    <div >
                                        <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
                                            <input name="ads[]" value="${ad.id}" type="checkbox" class="new-control-input">
                ...
                $("#categoriesList").html('')
                $.ajax({
                    url : "/admin-panel/adpro_home_sections/fetch/2",
                    type : 'GET',
                    success : function (data) {
                ...
                $.ajax({
                    url : "/admin-panel/adpro_home_sections/fetch/" + secType,
                    type : 'GET',
                    success : function (data) {
                        $("#ads_check").prop("disabled", true)
                        $("#ads_check").hide()
        ...
        <form action="" method="post" enctype="multipart/form-data" >
            ...
            <div class="form-group">
                ...
                <select id="type" name="type" class="form-control">
                    ...
                    <option value="3">{{ __('messages.offers') }}</option>
                    <option value="4">{{ __('messages.feature_ads') }}</option>
                </select>
            </div>
            ...
            <div style="display : none" class="form-group" >
                ...
                <select id="brandsList" name="products[]" class="form-control tags" multiple="multiple">
                </select>
            </div>
