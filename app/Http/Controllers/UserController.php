...
class UserController extends Controller
{
    ...
    public function getaddetails(Request $request){
        ...
        if ($request->lang == 'en') {
            ...
            $categoryOptions = CategoryOption::where('category_id', $ad['category_id'])->where('deleted', 0)->select('id as option_id', 'title_en as title')->get();
